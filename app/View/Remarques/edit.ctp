...
<?php echo $this->Form->create('Remarque'); ?>
	<fieldset>
		<legend><?php echo __('Edit Remarque'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Remarque.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Remarque.id'))); ?></li>
