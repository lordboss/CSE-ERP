...
<?php echo $this->Form->create('Competence'); ?>
	<fieldset>
		<legend><?php echo __('Edit Competence'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Competence.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Competence.id'))); ?></li>
