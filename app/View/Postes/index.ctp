<div class="postes index">
	...
	<tr>
		<td><?php echo h($poste['Poste']['id']); ?>&nbsp;</td>
		<td><?php echo h($poste['Poste']['nom']); ?>&nbsp;</td>
		<td><?php echo h($poste['Poste']['role']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $poste['Poste']['id']), null, __('Are you sure you want to delete # %s?', $poste['Poste']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
